...
def main():
    ...
    num_of_params = len(flatten_params(model)) + 308000000 #Add an additional 308 million params to represent the number of params in gemmaembed LLM.
    ...
    lr_list = [0.5, 0.1, 0.01, 0.001, 0.0001, 0.00001, 0.000001] #List of learning rates. 
    best_loss = float('inf') 
