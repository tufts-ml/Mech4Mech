...
The user also has as choice to plot a segment of the data that has the highest density regions of mechanistic reasoning (similar to Figure 3 in the arXiv paper). The user can specify the the number of time steps in the region. 
